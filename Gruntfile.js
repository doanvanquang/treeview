  ...
  grunt.initConfig({
    ...
    connect: {
      ...
      livereload: {
        options: {
          open: true,
          combine: ['<%= yeoman.compileTmp %>', '<%= yeoman.app %>'],
    ...
    compass: {
      options: {
        ...
        fontsDir: '<%= yeoman.src %>/sass/fonts',
